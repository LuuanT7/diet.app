...
1. Clone este repositório:
   ```bash
   https://github.com/LuuanT7/diet.app.git
2. Acesse o diretório do projeto e instale as dependências do backend:
  cd diet.app/backend
  npm install
...
4. Inicie o servidor backend:
  cd ../backend
  npm run dev
6. Configure as variáveis de ambiente para o Google Gemini AI.
7. Para iniciar o app mobile, utilize o Expo:
   cd ../mobile
   expo start
